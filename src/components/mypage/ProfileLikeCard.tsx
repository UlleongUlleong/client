    ...
    <ProfileLikeCardStyle onClick={handleCardClick}>
      ...
      <div className="cardContent">
        ...
        <div className="cardStars">
          ...
          <div className="rating">{scoreAverage.toFixed(1)}</div>
        </div>
      </div>
    </ProfileLikeCardStyle>
  );
}

const ProfileLikeCardStyle = styled.div`
  display: flex;
  width: 100%;
  max-width: 600px;
  min-height: 240px;
...
export default ProfileLikeCard;
